...
export async function POST(
  ...
  const upstreamUrl = new URL(`${baseUrl}/errors/${encodeURIComponent(slug)}/vote`);
  ...
  try {
    ...
    const helpfulVotes = extractNumber(payload, 'helpfulVotes');
    const normalized = { success: upstreamResponse.ok, helpfulVotes };
    ...
    return NextResponse.json(
      { success: false, helpfulVotes: null },
